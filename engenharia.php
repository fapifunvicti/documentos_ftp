...
<body>
    ...
    <span>
        ...
        <h1 class="titulo">Avaliação para Reconhecimento de curso</h1>
                <p>
                <i class="fa-solid fa-user-graduate"></i> Curso: Bacharelado em Engenharia de Computação na Modalidade em EaD</p>
                <p>
                <i class="fa-solid fa-school"></i> Código da avaliação:  227753
                </p>
        	<p>
                	<i class="fa-solid fa-school"></i> Processo: 202419846  
                </p>
        	<p>
                	<i class="fa-solid fa-school"></i> Data: 16 a 18 de junho de 2024.
                </p>
