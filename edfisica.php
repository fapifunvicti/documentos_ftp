...
<body>
    ...
    <span>
        ...
        <h1 class="titulo">Renovação de  Reconhecimento de curso</h1>
                <p>
                <i class="fa-solid fa-user-graduate"></i> Curso: Educação Física Bacharelado</p>
                <p>
                <i class="fa-solid fa-school"></i> Código da avaliação:  229920
                </p>
        	<p>
                	<i class="fa-solid fa-school"></i> Processo: 202201187
                </p>
        	<p>
                	<i class="fa-solid fa-school"></i> Data: 26 a 28 de Novembro de 2025
                </p>
